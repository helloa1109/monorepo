...
import { Button, ChevronDown, H1, P } from '@mono/ui';
    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-20 text-center px-6 text-foreground">
        <H1 className="text-6xl md:text-8xl lg:text-9xl font-black mb-8 leading-tight tracking-tight">
          ...
          <P className="block text-base md:text-lg font-normal mt-6 tracking-widest text-muted-foreground [&:not(:first-child)]:mt-6"> {/* Keep mt-6 */}
            HELLO WORLD
          </P>
        </H1>
