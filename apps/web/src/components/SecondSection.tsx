...
export function SecondSection() {
  return (
    <section id="why-me" className="py-24 px-6 max-w-7xl mx-auto">
      <ScrollReveal>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {features.map((feature, index) => (
          <ScrollReveal key={index} delay={feature.delay}>
            <Card className="transition-all duration-500 group hover:border-primary/60 hover:shadow-lg hover:shadow-primary/10 hover:scale-[1.02] h-full">
